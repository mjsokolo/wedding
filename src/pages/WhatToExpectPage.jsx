      ...
      <div className="grid gap-8">
        <section>
          ...
          <p className="mt-2">
            ...
            overnight camping]. A detailed schedule will be shared closer to the
            date.
          </p>
        </section>
        <section>
          ...
          <p className="mt-2">
            Planning to camp with us? Bring a tent (or let us know if you need
            to borrow one), a sleeping bag, and layers for overnight
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            conditions], so pack layers and something for rain just in case.
          </p>
        </section>
        <section>
          <h3 className="font-serif text-xl">Kids, Pets & Alcohol</h3>
          <p className="mt-2">
            [Kids are welcome / this is an adults-only celebration]. [Pets are
            welcome if leashed / we ask that you leave pets at home]. [The bar
            will be stocked with X / this is a BYOB event] — let us know if you
            have questions.
          </p>
        </section>
      </div>
